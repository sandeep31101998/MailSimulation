...
<body>
	<table border="1" style="width: 100%">
		<tr>
			<th style="background-color: lightgrey; color: blue; height: 30px; text-align: center;">
				<a href="./compose">Compose</a>
			<th style="background-color: lightgrey; color: blue; height: 30px;text-align: center;"><a
